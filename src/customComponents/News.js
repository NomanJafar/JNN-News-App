...
export default class News extends Component {
    ...
    async componentDidMount(){
        let url="https://newsapi.org/v2/everything?q=tesla&from=2022-07-04&sortBy=publishedAt&apiKey=a99d51173fa7417ca1e8f81a81629cca";
    ...
    render() {
        return (
            <div>
                <div className="container"> <h1>News Headlines</h1></div>
                        ...
                        {this.state.articles.map((element) => {
                            return <div className="col-md-4" key={element.url}>
                                <NewsItem
                                    ...
                                    imageUrl={element.urlToImage?element.urlToImage:"https://scx2.b-cdn.net/gfx/news/2022/apple-was-accused-by-c.jpg"}
                                    newsUrl={element.url}
                                />
                            </div>
